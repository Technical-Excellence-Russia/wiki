...
Новички в [TDD](TDD.md) часто задаются вопросом, почему [TDD](TDD.md) не приводит if-else коду. Я обычно указываю на правило выше. Такой ответ удовлетворяет студентов, особенно когда я иллюстрирую эту идею [Kata](CodingDojoKata.md) по написанию кода для поиска простых множителей целого числа.

### Подбор простых множителей целого числа

Я изобрёл эту [Kata](CodingDojoKata.md) 10 лет назад, когда мой сын Джастин делал домашнее задание. Он должен был найти простые множители для нескольких целых чисел. Я ему сказал, что буду проверять его ответы в программе, которую для этого напишу. (Он должен был бы вводить свой вариант ответа, а программа проверяла, верен он или нет)
